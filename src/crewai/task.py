...
class Task(BaseModel):
    ...
    def interpolate_inputs(self, inputs: Dict[str, Any]) -> None:
        ...
        print(f"Original description: {self._original_description}")
        print(f"Original expected output: {self._original_expected_output}")
        ...
        print(f"Updated description: {self.description}")
        print(f"Updated expected output: {self.expected_output}")
